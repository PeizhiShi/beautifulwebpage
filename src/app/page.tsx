        ...
        <header className="flex flex-col md:flex-row gap-8 items-start pb-8 mt-6 mb-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              ...
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded text-sm">Large Language Model</span>
              <span className="bg-purple-50 text-purple-700 px-2 py-1 rounded text-sm">AI for Good</span>
            </div>
...
I am a Lecturer (equivalent to Assistant Professor in the U.S. system) in Applied Artificial Intelligence at the Centre for Decision Research, within the Analytics, Technology and Operations Department at the University of Leeds. My research interests lie in machine learning, and its real-world applications, with a current focus on sustainable manufacturing, and production research.            
        ...
        <nav className="mb-10">
          <ul className="flex flex-wrap gap-4 relative pb-4 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-px after:bg-gradient-to-r after:from-blue-200 after:via-blue-400 after:to-blue-200">
            <li><Link href="/research" className="text-blue-600 hover:text-blue-800 font-medium">Research</Link></li>
            <li><Link href="/publications" className="text-blue-600 hover:text-blue-800 font-medium">Publications</Link></li>
            <li><Link href="/teaching" className="text-blue-600 hover:text-blue-800 font-medium">Teaching</Link></li>
            <li><Link href="/cv" className="text-blue-600 hover:text-blue-800 font-medium">Curriculum Vitae</Link></li>
          </ul>
        </nav>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-blue-50 border-blue-100">
                <CardContent className="p-6">
                  ...
                  <Link href="/research?tab=sustainable-packaging" className="text-blue-600 hover:text-blue-800">Learn more →</Link>
                </CardContent>
              </Card>
              <Card className="bg-green-50 border-green-100">
                <CardContent className="p-6">
                  ...
                  <Link href="/research?tab=additive-manufacturing" className="text-blue-600 hover:text-blue-800">Learn more →</Link>
                </CardContent>
              </Card>
            </div>
          </section>
