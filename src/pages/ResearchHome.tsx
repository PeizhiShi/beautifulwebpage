          ...
          <section className="mb-10">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    <strong>Application Information:</strong> Visit the <a href="https://business.leeds.ac.uk/research-degrees" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 no-underline">official research degrees page</a> for PhD programs, requirements, and scholarships.
                  </p>
