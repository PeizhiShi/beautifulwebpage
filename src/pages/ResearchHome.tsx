          ...
          <section className="mb-10">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    <strong>Application Information:</strong> For detailed information about PhD programs, entry requirements, application procedures, fees and scholarships at Leeds University Business School, please visit the <a href="https://business.leeds.ac.uk/research-degrees" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 no-underline">official research degrees page</a>. The Business School offers research opportunities across seven departments including Analytics, Technology and Operations where I am based.
                  </p>
