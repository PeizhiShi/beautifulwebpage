                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">LUBS5586M: Quantitative Analysis</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-green-100 text-green-800 ml-4 flex-shrink-0">Module Leader</span>
                      </div>
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">LUBS5996M: Understanding Data for Decision Making</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800 ml-4 flex-shrink-0">Teaching Staff</span>
                      </div>
                      <p className="text-gray-600 flex items-center gap-2 flex-wrap">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">LUBS5990M: Machine Learning in Practice</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800 ml-4 flex-shrink-0">Teaching Staff</span>
                      </div>
                      <p className="text-gray-600 flex items-center gap-2 flex-wrap">
                    ...
                    <div className="border-l-4 border-red-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">LUBS5308M: Business Analytics and Decision Science</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800 ml-4 flex-shrink-0">Teaching Staff</span>
                      </div>
                      <p className="text-gray-600 flex items-center gap-2 flex-wrap">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">LUBS5988M: Research Design and Analysis</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800 ml-4 flex-shrink-0">Teaching Staff</span>
                      </div>
                      <p className="text-gray-600 flex items-center gap-2 flex-wrap">
                        <span>Semester 2 (Feb to Jun) 2023/24</span>
                    ...
                    <div className="border-l-4 border-yellow-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">Modelling and Visualization of High Dimensional Data</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-orange-100 text-orange-800 ml-4 flex-shrink-0">Teaching Assistant</span>
                      </div>
                      <p className="text-gray-600 flex items-center gap-2 flex-wrap">
                        <span>2015</span>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800">Postgraduate</span>
                    ...
                    <div className="border-l-4 border-teal-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">Introduction to Machine Learning</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-orange-100 text-orange-800 ml-4 flex-shrink-0">Teaching Assistant</span>
                      </div>
                      <p className="text-gray-600 flex items-center gap-2 flex-wrap">
                        <span>2015</span>
                    ...
                    <div className="border-l-4 border-pink-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">Algorithms and Imperative Programming</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-orange-100 text-orange-800 ml-4 flex-shrink-0">Teaching Assistant</span>
                      </div>
                      <p className="text-gray-600 flex items-center gap-2 flex-wrap">
                    ...
                    <div className="border-l-4 border-indigo-500 pl-4">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-semibold text-lg text-gray-800 flex-1">3rd Asian-Pacfic summer school on formal methods</h3>
                        <span className="px-2 py-1 rounded text-xs font-medium bg-orange-100 text-orange-800 ml-4 flex-shrink-0">Teaching Assistant</span>
                      </div>
                      <p className="text-gray-600 flex items-center gap-2 flex-wrap">
