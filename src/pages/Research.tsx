...
import { ArrowLeft, FileText, ExternalLink, ChevronDown, ChevronUp, MessageSquare, Printer, Eye, Gamepad2 } from "lucide-react";
...
const getProjectIcon = (title: string) => {
  ...
  if (title.includes("Build Orientation")) return <Printer size={20} className="mr-2" />;
  if (title.includes("Feature Recognition")) return <Eye size={20} className="mr-2" />;
